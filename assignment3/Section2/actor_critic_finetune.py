...
def actor_critic_finetune(
        ...
        policy_network=None,  # Accept pre-initialized policy network
        value_network=None  # Accept pre-initialized value network
):
    """
    ...
    value_network_ = value_network.to(device)
    value_network_.train()
